...
export class EventsImpl implements Events {
    ...
    async create(request: { body: CreateEventsRequest; }, options?: FSRequestOptions | undefined): Promise<FSResponse<void>> {
        return this.eventsImpl.createEvents(request, options);
    }
