 ...
 * Generated from schema: fullstory.v2.users.BatchUserImportRequest
 * Do not edit manually.
 */

import { Schema } from '@model/varsapi/Schema';
/**
 * @interface BatchUserImportRequest The request payloads contains the user data to be imported
 */
export interface BatchUserImportRequest {
    /**
