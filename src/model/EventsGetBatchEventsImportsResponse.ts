...
export class EventsGetBatchEventsImportsResponse {
    /**
    * Page of events import responses for the batch import
    */
    'results'?: Array<EventsCreateEventsResponse> = undefined;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "results",
            "baseName": "results",
            "type": "Array<EventsCreateEventsResponse>"
        },
        {
            "name": "total_records",
    ...
    static getAttributeTypeMap() {
        return EventsGetBatchEventsImportsResponse.attributeTypeMap;
    }
}
